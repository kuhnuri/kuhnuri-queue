...
VALUES
  ...
  (3, 'b1', 2, 'html5', 'file://in', 'file://out', 'process', NULL, NULL, NULL, 1),
  (4, 'b2', 2, 'upload', NULL, NULL, 'queue', NULL, NULL, NULL, 2),
  (5, 'c1', 3, 'html5', 'file://in', 'file://out', 'done', NULL, NULL, NULL, 1),
  (6, 'c2', 3, 'upload', NULL, NULL, 'queue', NULL, NULL, NULL, 2),
  (7, 'd1', 4, 'html5', 'file://in', 'file://out', 'done', NULL, NULL, NULL, 1),
  (8, 'd2', 4, 'upload', 'file://in', 'file://out', 'error', NULL, NULL, NULL, 2);
