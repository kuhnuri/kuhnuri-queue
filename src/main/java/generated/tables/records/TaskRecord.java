...
public class TaskRecord extends UpdatableRecordImpl<TaskRecord> implements Record11<String, String, String, String, Status, Integer, OffsetDateTime, OffsetDateTime, String, Integer, Integer> {

    private static final long serialVersionUID = -1802869357;
     ...
     */
    @Override
    public Row11<String, String, String, String, Status, Integer, OffsetDateTime, OffsetDateTime, String, Integer, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row11<String, String, String, String, Status, Integer, OffsetDateTime, OffsetDateTime, String, Integer, Integer> valuesRow() {
     ...
     */
    @Override
    public TaskRecord values(String value1, String value2, String value3, String value4, Status value5, Integer value6, OffsetDateTime value7, OffsetDateTime value8, String value9, Integer value10, Integer value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TaskRecord(String uuid, String transtype, String input, String output, Status status, Integer id, OffsetDateTime processing, OffsetDateTime finished, String worker, Integer job, Integer position) {
        super(Task.TASK);
